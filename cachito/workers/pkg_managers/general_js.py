...
def upload_non_registry_dependency(
    ...
    :param ChecksumInfo checksum_info: if not ``None``, the checksum of the downloaded artifact
        will be verified.
    :raise InvalidChecksum: if checksum is invalid
    :raise FileAccessError: if package.json file is not found/valid
    :raise UnsupportedFeature: if dependency is not supported
    """
