...
class Config(object):
    ...
    cachito_default_environment_variables = {
        "gomod": {},
        "npm": {
            "CHROMEDRIVER_SKIP_DOWNLOAD": {"value": "true", "kind": "string"},
            "CYPRESS_INSTALL_BINARY": {"value": "0", "kind": "string"},
            "GECKODRIVER_SKIP_DOWNLOAD": {"value": "true", "kind": "string"},
            "SKIP_SASS_BINARY_DOWNLOAD_FOR_CI": {"value": "true", "kind": "string"},
        },
    }
...
class TestingConfig(DevelopmentConfig):
    ...
    cachito_default_environment_variables = {
        "gomod": {"GO111MODULE": {"value": "on", "kind": "string"}},
        "npm": {
            "CHROMEDRIVER_SKIP_DOWNLOAD": {"value": "true", "kind": "string"},
            "SKIP_SASS_BINARY_DOWNLOAD_FOR_CI": {"value": "true", "kind": "string"},
        },
